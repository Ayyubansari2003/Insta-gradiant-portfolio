	...
	theme: {
		...
		extend: {
			colors: {
				...
				instagram: {
					royal: 'hsl(var(--instagram-royal))',
					indigo: 'hsl(var(--instagram-indigo))',
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--instagram-purple) / 0.3)' },
					'50%': { boxShadow: '0 0 40px hsl(var(--instagram-pink) / 0.6)' }
				}
			},
			animation: {
